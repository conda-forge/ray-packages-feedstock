...
Once the `conda-forge` channel has been enabled, `ray-all, ray-core, ray-dashboard, ray-data, ray-default, ray-k8s, ray-rllib, ray-serve, ray-tune` can be installed with:
